...
CREATE TABLE `orion-ops`.`application_action`  (
...
CREATE TABLE `orion-ops`.`application_action_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `stage_type` tinyint(0) NULL DEFAULT NULL COMMENT '阶段类型 10构建 20发布',
...
CREATE TABLE `orion-ops`.`application_build`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `vcs_id` bigint(0) NULL DEFAULT NULL COMMENT '版本控制id',
...
CREATE TABLE `orion-ops`.`application_env`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` bigint(0) NULL DEFAULT NULL COMMENT '应用id',
  `profile_id` bigint(0) NULL DEFAULT NULL COMMENT '环境id',
...
CREATE TABLE `orion-ops`.`application_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`application_machine`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `app_id` bigint(0) NULL DEFAULT NULL COMMENT '应用id',
  `profile_id` bigint(0) NULL DEFAULT NULL COMMENT '环境id',
...
CREATE TABLE `orion-ops`.`application_profile`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `profile_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '环境名称',
...
CREATE TABLE `orion-ops`.`application_release`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `release_status` tinyint(0) NULL DEFAULT NULL COMMENT '发布状态 10待审核 20审核驳回 30待发布 40发布中 50发布完成 60发布停止 70初始化失败 80发布失败',
...
CREATE TABLE `orion-ops`.`application_release_machine`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`application_vcs`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `vcs_type` tinyint(0) NULL DEFAULT NULL COMMENT '类型 1git',
  ...
  `vcs_status` int(0) NULL DEFAULT NULL COMMENT '状态 10未初始化 20初始化中 30正常 40失败',
  `vcs_auth_type` int(0) NULL DEFAULT 10 COMMENT '认证类型 10密码 20令牌',
  `vcs_token_type` int(0) NULL DEFAULT NULL COMMENT '令牌类型 10github 20gitee 30gitlab',
  `deleted` tinyint(0) NULL DEFAULT 1 COMMENT '是否删除 1未删除 2已删除',
  `create_time` datetime(4) NULL DEFAULT CURRENT_TIMESTAMP(4) COMMENT '创建时间',
  `update_time` datetime(4) NULL DEFAULT CURRENT_TIMESTAMP(4) ON UPDATE CURRENT_TIMESTAMP(4) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '应用版本控制' ROW_FORMAT = Dynamic;

CREATE TABLE `orion-ops`.`command_exec`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`command_template`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`file_tail_list`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `machine_id` bigint(0) NULL DEFAULT NULL COMMENT '机器id',
...
CREATE TABLE `orion-ops`.`file_transfer_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `orion-ops`.`history_value_snapshot`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`machine_env`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `machine_id` bigint(0) NULL DEFAULT NULL COMMENT '机器id',
  `attr_key` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'key',
  `attr_value` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'value',
...
CREATE TABLE `orion-ops`.`machine_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`machine_proxy`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`machine_secret_key`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`machine_terminal`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `enable_web_gl` tinyint(0) NULL DEFAULT 2 COMMENT '是否开启webGL加速 1开启 2关闭',
  `deleted` tinyint(0) NULL DEFAULT 1 COMMENT '是否删除 1未删除 2已删除',
  `create_time` datetime(4) NULL DEFAULT CURRENT_TIMESTAMP(4) COMMENT '创建时间',
  `update_time` datetime(4) NULL DEFAULT CURRENT_TIMESTAMP(4) ON UPDATE CURRENT_TIMESTAMP(4) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `orion-ops`.`machine_terminal_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `orion-ops`.`scheduler_task`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`scheduler_task_machine`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
CREATE TABLE `orion-ops`.`scheduler_task_machine_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `task_id` bigint(0) NULL DEFAULT NULL COMMENT '任务id',
...
CREATE TABLE `orion-ops`.`scheduler_task_record`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `task_id` bigint(0) NULL DEFAULT NULL COMMENT '任务id',
  `task_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务名称',
...
CREATE TABLE `orion-ops`.`system_env`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `attr_key` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'key',
...
CREATE TABLE `orion-ops`.`user_event_log`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `orion-ops`.`user_info`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
