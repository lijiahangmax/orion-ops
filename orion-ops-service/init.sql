...
CREATE TABLE `application_release`  (
  ...
  `release_status` tinyint(4) NULL DEFAULT NULL COMMENT '发布状态 10待审核 20审核驳回 30待发布 40发布中 50发布完成 60发布停止 70初始化失败 80发布失败',
...
CREATE TABLE `application_vcs`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '应用版本控制' ROW_FORMAT = Dynamic;
