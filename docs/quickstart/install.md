...
复制 orion-ops/orion-ops-api/orion-ops-api/target/orion-ops-web-1.2.0.jar 到 /data/orion
# 启动后台服务
nohup java -jar orion-ops-web-1.2.0.jar --spring.profiles.active=prod --generator-admin &
# 启动 nginx
service nginx start
```
