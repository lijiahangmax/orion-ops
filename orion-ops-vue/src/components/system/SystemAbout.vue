    ...
    <div class="about-descriptions">
      <a-descriptions>
        ...
        <a-descriptions-item label="github 地址" :span="3">
          <a class="about-value" href="https://github.com/lijiahangmax/orion-ops">https://github.com/lijiahangmax/orion-ops</a>
        </a-descriptions-item>
        <a-descriptions-item label="gitee 地址" :span="3">
          <a class="about-value" href="https://gitee.com/lijiahangmax/orion-ops">https://github.com/lijiahangmax/orion-ops</a>
        </a-descriptions-item>
      </a-descriptions>
    </div>
  </div>
